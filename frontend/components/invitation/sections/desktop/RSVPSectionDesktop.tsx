...
export default function RSVPSectionDesktop({ token, nombreFamilia, ApellidosFamilia, esFamilia, pasesAsignados, pasesConfirmados: initialPases, statusRSVP: initialStatus, rondaInvitado }: Props) {
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-2 gap-20 items-start">
        ...
        <div className="flex flex-col">
          ...
          <p className="font-principal text-sm text-azul/60 tracking-[0.06em] mb-8">
            Por favor confirmar antes del {getDeadline(rondaInvitado)}
          </p>
