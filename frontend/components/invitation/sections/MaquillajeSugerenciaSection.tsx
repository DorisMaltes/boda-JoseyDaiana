...
/* ── Card reutilizable ────────────────────────────────────── */
interface MaquilladoraCardProps {
  nombre: string;
  descripcion: string;
  whatsapp: string;
  instagram: string;
...
function MaquilladoraCard({ nombre, descripcion, whatsapp, instagram, index }: MaquilladoraCardProps) {
  ...
  return (
    ...
    >
      ...
      <p className="font-principal text-sm text-terracota text-center tracking-wide">
        {descripcion}
      </p>
      ...
      <div className="flex gap-3 mt-1">
        ...
        <a
          ...
          className="flex items-center gap-2 px-5 py-2 text-sm text-white font-principal font-bold bg-verde rounded-full"
        >
          <WhatsAppIcon />
          WhatsApp
        </a>

        {/* Botón Instagram — terracota */}
        <a
          href={instagram}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-5 py-2 text-sm text-white font-principal font-bold bg-terracota rounded-full"
        >
          <InstagramIcon />
          Instagram
        </a>
  ...
  return (
    <section id="maquillaje" className="relative flex flex-col items-center bg-ivory px-6 pt-10 overflow-hidden">
      ...
      <div className="absolute top-20 -left-3 pointer-events-none z-10 ">
        <Image
          src="/assets/componentes/flor9.png"
          alt=""
          width={90}
          height={163}
          className="rotate-37"
      ...
      {/* ── Flor10 esquina superior derecha ────────────────── */}
      <div className="absolute top-20 -right-2  pointer-events-none z-10 ">
        <Image
          src="/assets/componentes/flor10.png"
          alt=""
          width={86}
          height={155}
          className="-rotate-43"
      ...
      {/* ── Título ─────────────────────────────────────────── */}
      <h2 className="font-cursiva text-6xl leading-tight text-azul text-center mb-10 pt-4 ">
      ...
      {/* ── Flor8 inferior — igual que flor7 en HospedajeSection */}
      <div className="relative z-10 -mb-10 mt-6">
        <Image
          src="/assets/componentes/flor8.png"
          alt=""
          width={360}
          height={131}
          className="pb-2"
